...
int* simplifyLevel2(int* moves, int length){

    int* simplifiedMoves1 = simplifyLevel1(moves, length);
    int* simplifiedMoves2 = simplifyLevel1(simplifiedMoves1, length);

    return simplifiedMoves2;

}

int* simplifyLevel1(int* moves, int length){
